...
### Changed
- Improved launcher border UI: the accent color now dynamically wraps the entire window instead of just the search input.
- Refined panel margins and padding to eliminate unwanted bottom border artifacts when there are no search results.

### Fixed
- Fixed minor syntax warning (`explicit_auto_deref`) in search core raised by Clippy.

## [0.8.1] - 2026-07-14

### Added
- GitHub Actions workflows for automated Continuous Integration (CI) and Release creation.
- Nord Theme (Frost and Snow Storm / Polar Night) added to the customizable Accent Colors.
